...
function App() {
  ...
  const onAddPost = useCallback(function handleAddPost(post) {
  ...
  return (
    <section>
      ...
      />
      <Main posts={searchedPosts} onAddPost={onAddPost} />
      <Archive archiveOption={archiveOption} onAddPost={onAddPost} />
      <Footer />
    </section>
  );
}
...
//this will return a memoized component
